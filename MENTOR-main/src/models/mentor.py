...
class MENTOR(GeneralRecommender):
    def __init__(self, config, dataset):
        ...
        self.weight_u_new = nn.Parameter(nn.init.xavier_normal_(
    ...
    def forward(self, interaction,adj,train=False):
       ...
       #扩展图id和项目项目图的嵌入进行乘积         
        ...
        user_rep_n1 = self.weight_u_new.transpose(1, 2) * user_rep_n1
        ...
        user_rep_n2 = self.weight_u_new.transpose(1, 2) * user_rep_n2
    ...
    def calculate_loss(self, interaction):
        ...
        return loss_value + reg_loss + mask_g_loss 
